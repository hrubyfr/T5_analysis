...
class Histograms{
	...
	public:
		Histograms(int default_can_size_x = 1800,
			   int default_can_size_y = 900,
			   int default_bins = 100,
		...
		void hist_projectX(const std::string& source_name, const std::string& new_name, int first_y_bin, int last_y_bin);
